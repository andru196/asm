...
/*   Updated: 2020/10/18 15:03:33 by mschimme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
sh ./t_compiler.sh t_op_05_sub "./src/op/op_05_sub.c ./src/op/op_cont.c ./src/op/arena_get.c ./src/flip_endian/end_01_conv_1_4.c ./src/flip_endian/end_02_conv_5-8.c ./src/exec/get_operands.c"
*/
...
int						main(void)
{
	...
	op_sub(&nexus, nexus.carry->gen.carry, NULL, NULL);
	op_sub(&nexus, nexus.carry->gen.carry, NULL, NULL);
	op_sub(&nexus, nexus.carry->gen.carry, NULL, NULL);
	return (0);
}