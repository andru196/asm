...
/*   Updated: 2021/04/10 19:29:26 by mschimme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define MAN_SYN "./corewar [-dump 100] [-n 2 ./champ.cor] [./champ2.cor]"
...
# define MAN_DESC_5 "\t\tThe battle'll be interrupted after executing step of "
...
# define MAN_DESC_10 "e folowing Champ will be assigned\n\t\tautomatically.\n"
...
# define WAR_CTRL_1 "A champ got control chars within  name! Ignore the case?"
# define WAR_CTRL_2 "A champ got control chars within  desc! Ignore the case?"
...
# define CONF_DESC_1 "The battle arena was configured as the following:"
